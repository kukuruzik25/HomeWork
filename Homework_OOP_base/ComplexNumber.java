public class ComplexNumber {
	...
	public ComplexNumber mult(ComplexNumber chislo2) {
		...
		double real_new = old_real * chislo2.real - this.fake * chislo2.fake;
		double fake_new = old_real * chislo2.fake + this.fake * chislo2.real;
		return new ComplexNumber(real_new, fake_new);
	}
	public void mult2(ComplexNumber chislo2) {
		this.real = this.real * chislo2.real - this.fake * chislo2.fake;
		this.fake = this.real * chislo2.fake + this.fake * chislo2.real;
	}
